defmodule SinghSabhaWeb.UserLive.Login do
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm space-y-4">
      ...
      <div :if={local_mail_adapter?()} class={["alert", Colour.badge_colour(:blue)]}>
  ...
  defp local_mail_adapter? do
    Application.get_env(:singh_sabha, SinghSabha.Mailer)[:adapter] == Swoosh.Adapters.Local
  end
end
